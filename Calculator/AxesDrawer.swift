...
class AxesDrawer
{
    ...
    convenience init(color: UIColor, contentScaleFactor: CGFloat) {
        self.init() // this is ok... because all variables have been given a default value, Swift provides an initialiser that simply sets up the object with these defaults
        self.color = color
